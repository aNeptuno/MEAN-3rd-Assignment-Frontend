...
@Component({
  ...
  template: `
    ...
    [formGroup]="userForm" (ngSubmit)="submitForm()">
   ...
   <div class="mb-3">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" formControlName="genre" name="genre" id="genre-woman" value="woman" required>
            <label class="form-check-genre" for="genre-woman">Woman</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" formControlName="genre" name="genre" id="genre-men" value="men">
            <label class="form-check-genre" for="genre-men">Men</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" formControlName="genre" name="genre" id="genre-other" value="other">
            <label class="form-check-genre" for="genre-other">Other</label>
        </div>
   </div>

   <button class="btn btn-primary" type="submit" [disabled]="userForm.invalid">Add user</button>
...
export class UserFormComponent implements OnInit{
  ...
  get genre() {return this.userForm.get('genre')!; }
